 ...
 *
 * @see https://github.com/penclipai/paperclip-cn/issues/8723
 */
...
vi.mock("@penclipai/adapter-utils/server-utils", async (importOriginal) => {
  const actual = await importOriginal<typeof import("@penclipai/adapter-utils/server-utils")>();
  return {
    ...actual,
